...
| **ATH_DCA** | 🚨 | **비상 모드** — 급락 시 자동 전환 | 3차 ATH 하락분할 DCA 매수 (1차 -30% / 2차 -50% / 3차 -65%) |
...
ATH_DCA ──────────────────────────────▶ LOC
  ...
  ⚠️ 예외 (2026-08-15): 3차까지 전부 발동(예비금 소진) 시 위 조건과 무관하게
     **사이클 종료 → LOC 즉시 복귀** — 신고가 +1% / 30영업일 대기 없이 LOC 20분할 재개
