...
- **달러 알리미 (dollar_alerter.py, 2026-08-17 신규)**: 박성현 『매직 스플릿』의 달러 매매 아이디어를
  ...
  +0.5% (`SELL_TARGET_PCT`) — 백테스트(2004~2026, 스프레드 왕복 0% = 나무 멤버스 100% 환전
  우대 반영, 2026-08-17 사용자 앱 확인) 결과: '상승 매수/하락 매도' 해석은 CAGR 음수(패배),
  **'하락 매수/익절 매도' 해석만** CAGR +5.2% vs 바이앤홀드 +0.8%·MDD -17.2%로 우위 (95% 우대
  왕복 0.1% 기준은 CAGR +4.1%·회당 +0.40% — 멤버스 100%가 +1.1%p 개선, 회당 +0.50%는 책의
  '평균 0.5%' 주장과 일치). ⚠️ **'1년 97% 수익률'은 어떤 해석으로도 재현 불가** (최고 연도 +12.8%) — 수수료 0% 가정의
