...
SYSTEM_TAG             = "[GARCH]"  # Distinguishes this engine's Discord messages from the plain-STAT variant
...
def _calculate_garch_sigma_from_closes(closes, lookback_days: int) -> float:
    # GARCH 모델을 위한 수익률 데이터 처리 및 모델링 로직
